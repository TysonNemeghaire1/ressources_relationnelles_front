...
export default function Login() {
  ...
  return (
    <main className="pb-20">
      <h1 className="text-4xl text-gray-700 text-center font-light mb-4 align-top pt-20">CONNEXION</h1>
      <div className="flex flex-col items-center justify-center p-4 white h-full w-full">
        <form className="space-y-4">
          <div className="flex flex-col md:flex-row gap-2 auto-rows-auto md:h-full w-full">
            <div className='flex items-center justify-center h-1/3 w-auto  md:py-10 w-full'>
              <div>
